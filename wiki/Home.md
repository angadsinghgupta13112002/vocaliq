...
2. **Two-pass Gemini analysis** scores the speech 1–10 and generates timestamped feedback
3. **Coaching report** shows score breakdown, flagged moments, improvement tips, vocal control advice, and a personalized practice plan
...
| 📈 Dashboard | Score history chart, best/average score, session list |
...
| AI | Google Gemini 2.5 Flash (two-pass chain via Gemini File API) |
